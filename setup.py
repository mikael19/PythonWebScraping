...
#
# However, when we do this, we also import `webscraper/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'webscraper_cli = webscraper.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'webscraper_gui = webscraper.gui:entry_point'
        # ]
    }
)
